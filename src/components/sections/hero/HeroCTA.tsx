  ...
  return (
    <div ref={ref} className="mt-8 flex flex-wrap gap-4">
      <MagneticButton
        as="a"
        href="/projects"
        className="inline-flex h-[52px] items-center justify-center rounded-[12px] bg-cta-primary px-6 text-base font-medium text-white [text-shadow:0_1px_1px_rgba(0,0,0,0.35)] transition-colors hover:bg-cta-hover active:bg-brand-active"
      >
        View Case Studies
      </MagneticButton>
      <a
